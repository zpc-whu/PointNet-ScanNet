...
class ScannetDataset():
    def __init__(self, root, npoints=8192, split='train', file='05'):
        self.npoints = npoints
        self.root = root
        self.split = split
        self.file = file
        self.data_filename = os.path.join(self.root, self.split, '%s.pickle'%(self.file))
...
if __name__=='__main__':
        tt = ScannetDataset('/home/u/pointnet2/data/scannet_data_pointnet2', split='train', npoints=8192)
        print len(tt)
        print tt.shap
        exit()
    # d = ScannetDatasetWholeScene(root = './data', split='train', npoints=8192)
